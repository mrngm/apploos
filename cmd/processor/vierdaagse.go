...
var (
	VierdaagseStartTime = time.Date(2025, 7, 12, ROLLOVER_HOUR_FROM_START_OF_DAY, 0, 0, 0, time.FixedZone("CEST", 2*60*60))
	VierdaagseEndTime   = time.Date(2025, 7, 19, ROLLOVER_HOUR_FROM_START_OF_DAY, 0, 0, 0, time.FixedZone("CEST", 2*60*60))
)
